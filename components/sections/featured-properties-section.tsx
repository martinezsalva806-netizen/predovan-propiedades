...
export function FeaturedPropertiesSection() {
  ...
  const properties = useMemo(() => active === 'Todos' ? featuredProperties : featuredProperties.filter((item) => item.market === active.toLowerCase() || (active === 'Emprendimientos' && item.type === 'depto')), [active])
  ...
  return (
    <section id="destacadas" className="relative overflow-hidden bg-[linear-gradient(180deg,rgba(15,19,24,0.98),rgba(27,31,38,0.96))] py-20 text-white">
      ...
      <div className="container-grid relative z-10">
        ...
        <div className="mb-8 rounded-[26px] border border-brand-500/20 bg-brand-500/10 px-5 py-4 text-sm text-white/85">
          <strong>Consultanos por WhatsApp</strong> sobre cualquiera de estas propiedades. Las cards abren su ficha completa.
        </div>
